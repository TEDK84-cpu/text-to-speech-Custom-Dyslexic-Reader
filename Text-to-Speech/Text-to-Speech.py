...
def setup_portable_environment():
    ...
    try:
        ...
        global TESSERACT_PATH, SETTINGS_FILE
...
class ScreenTextSelector:
    ...
    def create_ui(self):
        ...
        # Title
        title_label = tk.Label(main_frame, text="Screen Text Selector", font=("Arial", 16, "bold"))
        ...
        instructions = tk.Label(
            instructions_frame,
            text="1. Click 'Start Selection' or press Ctrl+Shift+S\n"
                 "2. Click and drag to select text anywhere on screen\n"
                 "3. Release mouse button to capture the text\n"
                 "4. Click 'Start Reading' or press Ctrl+Shift+R to read captured text\n"
                 "5. Press Ctrl+Shift+X anytime to stop reading",
            justify=tk.LEFT,
            font=("Arial", 10)
        )
        ...
        # Text area
        text_frame = tk.LabelFrame(main_frame, text="Captured Text", padx=10, pady=10)
        text_frame.pack(fill=tk.BOTH, expand=True)
        
        self.text_area = tk.Text(text_frame, wrap=tk.WORD, height=10)
        ...
        self.start_selection_button.grid(row=0, column=0, padx=5, sticky="ew")
        ...
        self.start_reading_button.grid(row=0, column=1, padx=5, sticky="ew")
        ...
        self.stop_speech_button.grid(row=0, column=2, padx=5, sticky="ew")
...
class SpeechToTextWindow:
    def __init__(self, parent):
        ...
        # Configure recognizer settings for better sentence capture
        self.recognizer.energy_threshold = 200  # Lower threshold for better sensitivity
        self.recognizer.dynamic_energy_threshold = True
        self.recognizer.dynamic_energy_adjustment_damping = 0.1  # Faster adjustment
        self.recognizer.dynamic_energy_ratio = 1.1  # More sensitive to changes
        self.recognizer.pause_threshold = 1.0  # Longer pause threshold for complete sentences
    ...
    def create_ui(self):
        ...
        # Title
        title_label = tk.Label(main_frame, text="Speech to Text", font=("Arial", 16, "bold"))
        title_label.pack(pady=(0, 10))
        
        # Instructions frame
        instructions_frame = tk.LabelFrame(main_frame, text="How to Use", padx=10, pady=10)
        instructions_frame.pack(fill=tk.X, pady=(0, 10))
        
        instructions = tk.Label(
            instructions_frame,
            text="1. Select your microphone from the dropdown\n"
                 "2. Click 'Start Recording' to initialize\n"
                 "3. Click 'Start Talking' when ready to speak\n"
                 "4. Speak clearly into your microphone\n"
                 "5. Click 'Stop Talking' when done\n"
                 "6. Click 'Stop Recording' to process\n"
                 "7. Use 'Read Text' to listen to recognized text\n"
                 "8. Use 'Copy to Main' to transfer text",
            justify=tk.LEFT,
            font=("Arial", 10)
        )
        instructions.pack(anchor=tk.W)
        ...
        mic_frame = tk.LabelFrame(main_frame, text="Microphone Selection", padx=10, pady=10)
        ...
        self.device_dropdown = ttk.Combobox(mic_frame, textvariable=self.device_var, values=device_names, state='readonly')
        ...
        text_frame = tk.LabelFrame(main_frame, text="Recognized Text", padx=10, pady=10)
        ...
        self.text_area = tk.Text(text_frame, wrap=tk.WORD, height=6, yscrollcommand=scrollbar.set)
        ...
        recording_frame = tk.LabelFrame(controls_frame, text="Recording Controls", padx=10, pady=10)
        ...
        self.start_record_button.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
        ...
        self.stop_record_button.grid(row=0, column=1, padx=5, pady=5, sticky="ew")
        ...
        self.start_talk_button.grid(row=1, column=0, padx=5, pady=5, sticky="ew")
        ...
        self.stop_talk_button.grid(row=1, column=1, padx=5, pady=5, sticky="ew")
        
        # Read controls frame
        read_frame = tk.LabelFrame(controls_frame, text="Text Reading Controls", padx=10, pady=10)
        ...
        self.stop_read_button.grid(row=0, column=1, padx=5, pady=5, sticky="ew")
        ...
        copy_button.grid(row=0, column=0, padx=5, sticky="ew")
